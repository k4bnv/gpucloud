...
Optional repo secret: `RUNPOD_API_KEY` (Settings → Secrets and variables → Actions) — same purpose as the `.env` var above, but for the CI job specifically; the two are independent.
